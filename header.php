		...
		<section class="header-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 col-sm-3 col-xs-12 text-center header-social text-right search-cart">
						<ul class="list-inline">
							<li><a href="https://www.facebook.com/bar.america.satx"><i class="fa fa-facebook"></i></a></li>
							<li><a href="https://twitter.com/baramericasatx"><i class="fa fa-twitter"></i></a></li>
							<li><a href="https://instagram.com/bar_america42"><i class="fa fa-instagram"></i></a></li>
